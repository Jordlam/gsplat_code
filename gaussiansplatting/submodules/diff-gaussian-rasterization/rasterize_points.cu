...
RasterizeGaussiansCUDA(
  ...
  return std::make_tuple(rendered, out_color, out_feature_map, out_depth, radii, geomBuffer, /***/
...
RasterizeGaussiansBackwardCUDA(
  ...
  torch::Tensor dL_dsemantic_feature = torch::zeros({P, semantic_feature.size(1), NUM_SEMANTIC_CHANNELS}, means3D.options()); /***/ // Hard-coded?
  ...
  return std::make_tuple(dL_dmeans2D, dL_dcolors, dL_dsemantic_feature, dL_dopacity, dL_dmeans3D,
